...
class Caption2InstructDataset(Dataset):
    def __init__(self,
        ...
        #     self.datas = datas[chunk_index*chunks: chunk_index + chunks]
        # else:
...
def parse_option():
    ...
    parser.add_argument('--save_path', type=str, default="data/objaverse/cap3d_automated_objaverse_highquality_instruct_550k.json", help='root path of dataset')
    # multi gpu settings
...
if __name__ == "__main__":
    ...
    train_dataset = Caption2InstructDataset(args.dataset_path)
